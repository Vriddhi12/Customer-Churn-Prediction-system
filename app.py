...
df = pd.read_csv("C:\\Users\\RAJIV\\OneDrive\\Desktop\\CustomerChurn-selected-columns.csv")
...
if page == "🏠 Home":
...
elif page == "⚙️ Customer Prediction":
    ...
    if st.button("🔍 Predict Churn", use_container_width=True):
        input_data = pd.DataFrame([[senior_citizen,partner,dependents,tenure,internet_service,online_security,online_backup,
    ...
    if graph == "Churn Distribution":
        ...
        sns.heatmap(graph_df.corr(),annot=True,cmap="coolwarm",fmt=".2f",annot_kws={"size":8},linewidths=0.5,ax=ax)
...
• Dataset cleaned and preprocessed before training.
""")
